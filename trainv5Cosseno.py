...
def train_anti_overfitting():
    ...
    VALIDATION_BATCHES = 200  # Validar mais batches para precisão
    ...
    for epoch in epoch_pbar:
        ...
        for batch_idx, batch in enumerate(train_pbar):
            ...
            # Adicionar regularização L2 mínima
            if best_accuracy > 0.90:  # Só adicionar se já está performando bem
                l2_lambda = 1e-5  # Muito pequeno
        ...
        with torch.no_grad():
            for batch_idx, batch in val_pbar:
                ...
                # Generate predictions com beams aumentados para melhor qualidade
